...
def move_corresponding_txt_files(source_dir_with_jpg, source_dir_with_txt, target_dir):
    ...
    jpg_files = [f for f in os.listdir(source_dir_with_jpg) if f.endswith('.png')]
...
def main():
    source_dir_with_jpg = '/home/road2022/Documents/aaaa/rokey_on_site/my_data/train/images'
    source_dir_with_txt = '/home/road2022/Pictures/gggg.labeling'
    target_dir = '/home/road2022/Documents/aaaa/rokey_on_site/my_data/train/labels'

    move_corresponding_txt_files(source_dir_with_jpg, source_dir_with_txt, target_dir)

    source_dir_with_jpg = '/home/road2022/Documents/aaaa/rokey_on_site/my_data/valid/images'
    target_dir = '/home/road2022/Documents/aaaa/rokey_on_site/my_data/valid/labels'
